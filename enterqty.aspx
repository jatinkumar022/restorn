<%@ Page Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="enterqty.aspx.cs" Inherits="enterqty" Title="Untitled Page" %>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="row g-4">
                            <div class="col-8 text-start">
                                 <asp:Image CssClass="img-fluid w-100 wow zoomIn" ID="Image1" runat="server" Height="350" Width="300" style="border-radius: 7%;"  />
                            </div>
                    ...
                    <div class="col-lg-6">
                       ...
                       <br />  <br />  <br />
                            <asp:Button ID="Button1" CssClass="btn-secondary btn btn-sm"  runat="server" Text="Continue Shopping" OnClick="Button1_Click" CausesValidation="false" />
